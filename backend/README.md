...
## Project Structure
    ...
    ├── testapiautodatamod_114417  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_114417`
...
2. Clone this repo and `cd testapiautodatamod_114417`
